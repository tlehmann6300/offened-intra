...
// CRITICAL: Suppress all error output initially for security
// This prevents any errors from being displayed before APP_ENV is determined
// Errors will still be logged according to php.ini settings
...
// Silently skip if .env doesn't exist - fallback to production mode
if (file_exists(__DIR__ . '/../.env')) {
    try {
        $dotenv = Dotenv\Dotenv::createImmutable(__DIR__ . '/..');
        $dotenv->load();
    } catch (Exception $e) {
        // Silently log error but don't display anything
